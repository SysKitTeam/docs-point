...
* [Configuration Inventory](configuration-inventory/README.md)
  * [Permission Requirements](configuration-inventory/permission-requirements.md)
  * [Deploy Configuration Inventory Module](configuration-inventory/deploy-configuration-inventory-module.md)
  * [Get to Know Configuration Inventory](configuration-inventory/get-to-know/README.md)
    * [Setup Configuration Inventory Settings](configuration-inventory/get-to-know/setup-configuration-inventory-settings.md)

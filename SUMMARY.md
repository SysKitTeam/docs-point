...
* [Releases](releases/README.md)
  * [SysKit Point 2023.1](releases/point-2023-1-release-note.md)
...
* [Requirements & Licensing](requirements-licensing/README.md)
  * [Permission Requirements](requirements-licensing/permission-requirements.md)
  * [Change Log](requirements-licensing/permission-requirements-change-log.md)
  * [Licensed Users Count](requirements-licensing/licensed-users-count.md)
* [Set Up with SaaS](set-up-saas/README.md)
  * [Installation](set-up-saas/installation/README.md)
     * [Trial](set-up-saas/installation/trial.md)
     * [Trial Limits](set-up-saas/installation/trial-limits.md)
  * [Licensing for SaaS](set-up-saas/licensing-for-saas/README.md)
     * [Purchasing SysKit Point for Cloud](set-up-saas/licensing-for-saas/purchasing-syskit-point.md)
* [Set Up with Data Center](set-up-data-center/README.md)
  * [Requirements](set-up-data-center/requirements/README.md)
    * [System Requirements](set-up-data-center/requirements/system-requirements.md)
  * [Installation](set-up-data-center/installation/README.md)
    * [Overview](set-up-data-center/installation/overview.md)
    * [Deploy SysKit Point](set-up-data-center/installation/deploy-syskit-point.md)
    * [Connect to Microsoft 365 Tenant](set-up-data-center/installation/connect-to-tenant.md)
    * [Set Up Custom Domain and SSL Certificate](set-up-data-center/installation/set-up-custom-domain-and-ssl-certificate.md)
    * [Upgrade SysKit Point](set-up-data-center/installation/upgrade-syskit-point.md)
    * [Azure Networking](set-up-data-center/installation/azure-networking.md)
  * [Activation](set-up-data-center/activation/README.md)
    * [Activate SysKit Point](set-up-data-center/activation/activate-syskit-point.md)
    * [Activation Privacy Statement](set-up-data-center/activation/activation-privacy-statement.md)

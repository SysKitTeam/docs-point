...
* [Product Updates](product-updates/README.md)
  * [SysKit Point 18.2](product-updates/point-18-2-release-note.md)
...
* [Installation & Configuration](installation-and-configuration/README.md)
  ...
  * [Deploy SysKit Point On-Premises](installation-and-configuration/deploy-on-premises/README.md)
    * [Overview](installation-and-configuration/deploy-on-premises/overview.md)
    * [Hardware and Software Requirements](installation-and-configuration/deploy-on-premises/hardware-software-requirements.md)
    * [Create SQL Database](installation-and-configuration/deploy-on-premises/syskit-point-database.md)
    * [Additional Virtual Machine Configuration](installation-and-configuration/deploy-on-premises/additional-vm-configuration.md)
    * [Configure URL for Point Web Application](installation-and-configuration/deploy-on-premises/ssl-certificate.md)
...
* [How To](how-to/README.md)
  ...
  * [Collect Microsoft 365 Data](how-to/collect-office-365-data.md)
* [Common Tasks](common-tasks/README.md)
  * [Check Access for Specific Microsoft 365 User](common-tasks/check-access-for-specific-user.md)
  * [Copy User Permissions](common-tasks/copy-user-permissions.md)
  * [Delete and Restore Users](common-tasks/delete-and-restore-users.md)
  ...
  * [Track Microsoft 365 External Users and Their Activities](common-tasks/track-external-users-and-their-activities.md)
  * [View Permission Changes in Microsoft 365](common-tasks/view-permission-changes.md)

...
* [Setup](setup/README.md)
    ...
    * [Licensing & Activation](setup/licensing-and-activation/README.md)
  ...
  * [Configuration](setup/configuration/README.md)
    * [Configure](setup/configuration/configure/README.md)
      * [Configuration Overview](setup/configuration/configure/how-to-configure-Point.md)
      * [Enable and Manage Role-Based Access](setup/configuration/configure/enable-role-based-access.md)
      * [Configure Storage Management](setup/configuration/configure/configure-storage-management.md)
      * [Set Up E-Mail Notifications](setup/configuration/configure/set-up-email.md)
      * [Configure Alerts](setup/configuration/configure/configure-alerts.md)
      * [Connect Service Account](setup/configuration/configure/connect-service-account.md)
      * [Upgrade SQL to Managed Identity Authentication](setup/configuration/configure/upgrade-SQL-to-managed-identity-authentication.md)
      * [Enable Power BI Data Collection](setup/configuration/configure/enable-powerBI-data-collection.md)
      * [Configure Report Data Limits](setup/configuration/configure/report-data-limits.md)
      * [Enable Auditing](setup/configuration/configure/turn-on-auditing.md)
      * [Audit Log for Syskit Point Settings](setup/configuration/configure/audit-log-for-settings.md)
      * [Exclude Service Account from Activity Tracking](setup/configuration/configure/ignore-service-account-activity-tracking.md)
      * [Exclude Users from Governance Tasks](setup/configuration/configure/exclude-users-tasks.md)
      * [Configure Environment for Storage Management](setup/configuration/configure/configure-point-for-storage-management.md)
      * [Manage Tenant Connection](setup/configuration/configure/manage-connection)

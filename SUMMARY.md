...
* [Set Up with Data Center](set-up-data-center/README.md)
  * [Deployment](set-up-data-center/deployment/README.md)
    ...
    * [System Requirements](set-up-data-center/deployment/system-requirements.md)
    * [Deploy SysKit Point](set-up-data-center/deployment/deploy-syskit-point.md)
    * [Connect to Microsoft 365 Tenant](set-up-data-center/deployment/connect-to-tenant.md)
    * [Set Up Custom Domain and SSL Certificate](set-up-data-center/deployment/set-up-custom-domain-and-ssl-certificate.md)
    * [Upgrade SysKit Point](set-up-data-center/deployment/upgrade-syskit-point.md)
    * [Azure Networking](set-up-data-center/deployment/azure-networking.md)

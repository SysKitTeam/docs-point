...
* Follow the wizard through the installation steps. All installation steps are described [here](deploy-syskit-point-on-premises/install-syskit-point-on-premises.md).

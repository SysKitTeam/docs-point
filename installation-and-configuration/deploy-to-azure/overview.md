...
4. **Global Administrator** account is required to [**provide application consent**](../../requirements/permission-requirements.md#global-administrator) during the setup

...
{% hint style="info" %}
**Hint!**  
Customizing the Access Review e-mail is possible only if the task delegation for the Access Review feature is enabled. For more information on that topic, visit the [following article](../governance-and-automation/permissions-review/enable-permissions-review.md).
{% endhint %}

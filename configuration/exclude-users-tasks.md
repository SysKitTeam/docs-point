...
The Governance-Excluded Users settings in Syskit Point allow you to exclude certain users from governance tasks or task-related e-mails.

The users added to this list do not receive any:
* Access Review tasks 

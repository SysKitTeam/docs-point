 ...
 * Under **Tenant settings (2)**, scroll down to the **Admin API settings (3)** section. 
 ...
 ![Setting admin API settings - service principals](../.gitbook/assets/enable-powerbi-data-collection_api-settings.png)
 ...
 ![Setting admin API settings - admin APIs responses](../.gitbook/assets/enable-powerbi-data-collection_api-settings-enhance.png)

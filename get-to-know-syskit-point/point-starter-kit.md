...
\--> Learn how to [turn on auditing](../setup/configuration/configure/essential/turn-on-auditing.md) in the Microsoft 365 Security & Compliance Center

\--> Learn how to track [external users](../access-management/track-external-users-and-their-activities.md) and their activity.

**Plus**: Set up [alerts](../setup/configuration/configure/additional/configure-alerts.md), prevent security issues, get real-time updates, and react quickly.
...
* [Set Up E-mail](../setup/configuration/configure/essential/set-up-email.md)
  * [Customize E-mails](../setup/configuration/customize/customize-emails.md)
* [Enable Role-Based Access](../setup/configuration/configure/essential/enable-role-based-access.md)
* [Enable Microsoft Teams Activity Tracking](../setup/configuration/configure/additional/microsoft-teams-activity.md)
* [Ignore Service Account Activity tracking](../setup/configuration/configure/additional/ignore-service-account-activity-tracking.md)

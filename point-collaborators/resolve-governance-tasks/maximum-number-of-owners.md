...
**Syskit Point sends an e-mail to existing owners** when there are Microsoft Teams or Microsoft 365 Groups that have more than the maximum number of owners assigned, as defined in the policy settings. The e-mail includes a list with all of the workspaces where the policy vulnerability was detected.

---
description: >-
  This article explains how to resolve the Minimum number of Owners policy
  vulnerabilities.
---
...
{% hint style="success" %}
By default, **Syskit Point suggests that Microsoft Teams and Microsoft 365 Groups should have at least 2 owners** so that if one owner leaves, Microsoft Teams and Microsoft 365 Groups are not left without an owner. [Syskit Point Administrators can change the minimum number of required owners to fit the organization’s policies.](../../governance-and-automation/automated-workflows/set-up-policies.md)
{% endhint %}

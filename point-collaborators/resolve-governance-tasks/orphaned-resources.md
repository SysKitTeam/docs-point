...
**This article shows how you can resolve the Orphaned Workspaces policy vulnerability** triggered when Syskit Point detects that Microsoft Teams and Microsoft 365 Groups don’t have active owners. 
...
* **Microsoft Teams or Microsoft 365 Group where the policy vulnerability was resolved (1)**
...
![Policy Vulnerability Resolved - E-mail](../../.gitbook/assets/orphaned-resources-confirmation-email.png)
...
![Policy Vulnerability E-mail](../../.gitbook/assets/orphaned-resources-suggest-owners-email.png)
...
![Policy Vulnerability - History Screen](../../.gitbook/assets/orphaned-resources-policy-history-screen-approver.png)

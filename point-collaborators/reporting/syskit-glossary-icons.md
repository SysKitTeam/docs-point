...
|![Security Group (On-Premises)](../../.gitbook/assets/glossary-icons-security-group-on-premises.png)|Security Group (On-Premises)|Security group synced to Entra ID from on-premises Active Directory.|
...
|![Distribution List (On-Premises)](../../.gitbook/assets/glossary-icons-distribution-list-on-premises.png)|Distribution List (On-Premises)|Distribution list synced to Entra ID from on-premises Active Directory.|

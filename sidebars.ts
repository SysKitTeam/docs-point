      ...
      items: [
        {
          ...
          items: [
            ...
            'releases/cloud/point-2026-04-14-release-note',
            'releases/cloud/point-2026-04-08-release-note',
            'releases/cloud/point-2026-03-31-release-note',
        ...
        },
        {
          ...
          items: [
            {
              type: 'category',
              label: 'Syskit Point 2026.3',
              link: {
                type: 'doc',
                id: 'releases/enterprise/syskit-point-2026-3/README',
              },
              items: [
                'releases/enterprise/syskit-point-2026-3/point-2026-3-159-release-note',
              ],
            },
            {
              type: 'category',
              label: 'Syskit Point 2026.2',
              link: {
                type: 'doc',
            ...
            },
            {
              ...
              items: [
                'releases/enterprise/syskit-point-2026-1/point-2026-1-133-release-note',
      ...
      items: [
        'governance-and-automation/syskit-point-tasks',
        {
          ...
          items: [
            ...
            'governance-and-automation/workspace-review/reminders-and-escalations',        {
              type: 'category',

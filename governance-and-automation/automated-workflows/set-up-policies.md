...
* [set up e-mail settings](../../setup/configuration/configure/essential/set-up-email.md)
* [enable Syskit Point Collaborators role](../../setup/configuration/configure/essential/enable-role-based-access.md)

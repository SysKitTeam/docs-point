...
* **Review action (9)**
    * Click this action to perform the Senstivity Review
...
Here, you can find the list of performed changes, as described for the active Sensitivity Review tasks.

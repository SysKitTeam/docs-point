...
| Send mail as a user | Application | Allows SysKit Point to send emails as signed in user so you can be notified if something important happens. \(coming soon\) |
| Read all usage reports | Application | Allows SysKit Point to read usage reports generated by Microsoft. |
| Read items in all site collections | Application | Allows SysKit Point to read documents and list items in all site collections and show you reports based on that data. |
| Sign in and read user profile | Application | Allows SysKit Point to sign you in and authenticate you with SysKit Point service. |
...
| Maintain access to data you have given it access to | Application | Allows SysKit Point to always show you the latest data about your environment. Additionally, allows SysKit Point to run long running actions started by users even if they sign out. |
| Sign users in | Application | Allows SysKit Point to sign you in. |

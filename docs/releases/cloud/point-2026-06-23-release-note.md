---
description: This article lists new features, improvements, and bug fixes in the Syskit Point Cloud version 2026.2.147.1
---
...
* **Improvements made to Exported Reports.**
  ...
  * **The Performed By and Extension columns are now visible** in the Exported Reports list, providing additional context for each export record.

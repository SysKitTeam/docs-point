...
* **Fixed an issue** where clicking the Resolve button for a task on the Tasks screen resulted in an error. The issue was limited to groups with many members.

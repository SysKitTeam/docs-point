...
* **Improvements made to Workspace Review.**
  ...
  * **Fixed an issue** where attempting to complete a Workspace Review task for a deleted private channel showed no explanation. 
    * A clear error message is now shown.

...
* **If you are a Syskit Point Admin**, [**read the Security & compliance checks article**](../../../governance-and-automation/security-compliance-checks/overview.md) to learn how to:

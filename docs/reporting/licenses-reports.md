...
* [Inactive Users with Assigned Licenses Report](#inactive-licenses-report)
...
* Total Annual Cost - money amount

* Total Purchased Licenses - number of

* Paid Licenses - number of

* Free Licenses - number of
...
* Potential Savings from:
  ...
  * Inactive Users - money amount

  * Unused Add-on Licenses - money amount

  * Redundant Licenses - money amount



* Most purchased licenses, showing a list of your licenses with graphs demonstrating the amount used for each
...
* The Number of Inactive Users with Assigned Licenses

...
<LandingTileGrid hasImages={false}>
  ...
  <LandingTile
    title="FAQ"
    description="Security, free trial, activation, licensing, compliance, privacy, we tried to cover it all for you. Please check if there is an answer to your question here, and if not, please feel free to contact us."
    linkUrl="/faq/"
    showLink={true}

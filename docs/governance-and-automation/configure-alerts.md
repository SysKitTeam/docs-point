...
![Sites - Configure Alerts action](../../static/img/configure-alerts-configure-site-specific-alerts.png)
...
![Users - Configure Alerts action](../../static/img/configure-alerts-configure-user-alerts.png)
...
![Sites overview screen - Configure Alerts action](../../static/img/configure-alerts-configure-site-specific-alerts.png)
...
![Configure Alerts dialog](../../static/img/configure-alerts-configure-alerts-dialog.png)
...
![Configure Alerts - Notifications tab](../../static/img/configure-alerts-notifications-tab.png)
...
![Configure Alerts - Filters tab](../../static/img/configure-alerts-filters-tab.png)
...
![Configure Alerts - Events tab](../../static/img/configure-alerts-events-tab.png)
...
![Alert E-mail](../../static/img/configure-alerts-alert-email.png)
...
![Home screen - Alerts tile](../../static/img/configure-alerts-welcome-home-alerts-tile.png)
...
![Alerts Overview screen – no row selection](../../static/img/configure-alerts-alerts-overview-screen-no-row-selection.png)
...
![Alerts History screen](../../static/img/configure-alerts-alerts-history-screen.png)

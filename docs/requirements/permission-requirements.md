...
| Read and write mail in all mailboxes                             | Application | Allows Syskit Point to send emails as a part of the Access Review, Workspace Review, Scheduled Reports, Alerts, and other features.                                                                                      |
| Send mail as any user                                            | Application | Allows Syskit Point to send emails as a part of the Access Review, Workspace Review, Scheduled Reports, Alerts, and other features.                                                                                      |

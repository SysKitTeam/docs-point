...
{% hint style="warning" %}
To generate the [Power Platform reports](../setup/configuration/configure/essential/enable-role-based-access.md) and complete the Power Platform actions, please ensure [you have enabled Power Platform data collection](../setup/configuration/configure/additional/power-platform.md).\

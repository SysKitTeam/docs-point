...
{% hint style="warning" %}
**Please note!**  
You can only delete users that exist in the **Entra ID**. Some external users in your tenant don’t appear in **Entra ID** as they only have access to selected documents. To remove such users, use the **Remove Access** action on the [**User Access Report**](check-access-for-specific-user.md).
{% endhint %}
...
{% hint style="warning" %}
**Please note!**  
When you delete a user from Entra ID, you have a period of 30 days to restore them. After 30 days, the user is permanently deleted and cannot be restored.
{% endhint %}

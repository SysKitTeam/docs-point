...
* **Improved performance** for Privileged Identity Management (PIM).
  ...
  * **Fixed a bug** where Entra ID groups weren’t taken into account for PIM if some members of those groups had administrative roles assigned.
...
* **Fixed a bug** where the Users overview showed additional users that no longer existed in the Entra ID.

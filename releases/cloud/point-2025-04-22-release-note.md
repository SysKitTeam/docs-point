...
{% hint style="warning" %}
**Please note!**\
Global admin re-consent is required after the upgrade to the latest version due to changes in APIs used to [detect Teams chat activity](../../setup/configuration/configure/additional/microsoft-teams-activity.md). [Learn more about permission changes here](../../setup/requirements/permission-requirements-change-log.md)
{% endhint %}

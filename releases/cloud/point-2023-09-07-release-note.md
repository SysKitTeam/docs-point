...
{% hint style="info" %}
**The Security & compliance dashboard is available to Syskit Point administrators only**.
>>>>>>> d417d21d3222e2f226517b4fb0f6ce8e0a1cb6ff
{% endhint %}
...
* **Automation**
  ...
  * **Existing customers can expect the automation option for the default policies to be turned off, and for policies previously configured by Syskit Point admin to stay the same**. It is advised for the Syskit Point Admins to check policy settings and enable automation where needed.
